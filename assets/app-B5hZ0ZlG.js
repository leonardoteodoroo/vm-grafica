...
Podem me orientar sobre o envio da arte e prazo de produção?`,C=`https://wa.me/5562993725371?text=${encodeURIComponent(M)}`;P&&(P.href=C),k&&(k.href=C)}a&&a.addEventListener("click",()=>{let t=parseInt(o.value,10)||1;t>1&&(o.value=t-1,l())}),r&&r.addEventListener("click",()=>{let t=parseInt(o.value,10)||1;o.value=t+1,l()}),o&&(o.addEventListener("input",l),o.addEventListener("change",l)),u.forEach(t=>{t.addEventListener("click",()=>{const c=parseInt(t.getAttribute("data-qty"),10);o.value=c,l()})}),l()}
