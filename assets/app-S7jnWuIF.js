(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))a(t);new MutationObserver(t=>{for(const i of t)if(i.type==="childList")for(const d of i.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function o(t){const i={};return t.integrity&&(i.integrity=t.integrity),t.referrerPolicy&&(i.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?i.credentials="include":t.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(t){if(t.ep)return;t.ep=!0;const i=o(t);fetch(t.href,i)}})();class B extends HTMLElement{connectedCallback(){const s=new Date().getFullYear();this.innerHTML=`
    ...
    `}getDefaultIcon(s){const o=["🎨","📍","💳","⚡","✨","📦","☕","🔥"];return o[s%o.length]}setupInteractions(){this.querySelectorAll(".faq-chat-trigger").forEach(o=>{o.addEventListener("click",a=>{var h,m;a.preventDefault();const t=o.closest(".faq-chat-card");if(!t)return;const i=t.classList.contains("is-open");this.querySelectorAll(".faq-chat-card").forEach(v=>{if(v!==t){v.classList.remove("is-open");const y=v.querySelector(".faq-chat-trigger");y&&y.setAttribute("aria-expanded","false");const u=v.querySelector(".faq-chat-user-bubble");u&&u.classList.remove("active")}}),i?(t.classList.remove("is-open"),o.setAttribute("aria-expanded","false"),(h=t.querySelector(".faq-chat-user-bubble"))==null||h.classList.remove("active")):(t.classList.add("is-open"),o.setAttribute("aria-expanded","true"),(m=t.querySelector(".faq-chat-user-bubble"))==null||m.classList.add("active"))})})}}customElements.get("faq-chat-accordion")||customElements.define("faq-chat-accordion",I);function O(e=document){const s=e.querySelectorAll(".faq-chat-card");s.length&&s.forEach(o=>{const a=o.querySelector(".faq-chat-trigger");a&&a.addEventListener("click",t=>{var d,h;t.preventDefault();const i=o.classList.contains("is-open");s.forEach(m=>{var v;if(m!==o){m.classList.remove("is-open");const y=m.querySelector(".faq-chat-trigger");y&&y.setAttribute("aria-expanded","false"),(v=m.querySelector(".faq-chat-user-bubble"))==null||v.classList.remove("active")}}),i?(o.classList.remove("is-open"),a.setAttribute("aria-expanded","false"),(d=o.querySelector(".faq-chat-user-bubble"))==null||d.classList.remove("active")):(o.classList.add("is-open"),a.setAttribute("aria-expanded","true"),(h=o.querySelector(".faq-chat-user-bubble"))==null||h.classList.add("active"))})})}function k(e,s,o,a,t,i){if(!e)return;const d=()=>Array.from(i).filter(u=>u.style.display!=="none"),h=()=>{const p=d()[0];if(!p)return 290;const f=parseInt(window.getComputedStyle(e).gap)||20,n=p.offsetWidth;if(window.innerWidth<=640)return n+f;const g=Math.max(1,Math.floor(e.clientWidth/(n+f)));return(n+f)*g},m=()=>{const u=e.scrollLeft,p=e.scrollWidth-e.clientWidth;if(p<=5?(s==null||s.classList.add("is-disabled"),o==null||o.classList.add("is-disabled"),s==null||s.setAttribute("disabled","true"),o==null||o.setAttribute("disabled","true")):(s==null||s.classList.remove("is-disabled"),o==null||o.classList.remove("is-disabled"),s==null||s.removeAttribute("disabled"),o==null||o.removeAttribute("disabled")),a){const f=a.querySelectorAll(".carousel-dot");if(f.length>0){const n=p>0?u/p:0,g=Math.min(Math.round(n*(f.length-1)),f.length-1);f.forEach((l,c)=>{c===g?(l.classList.add("is-active"),l.setAttribute("aria-selected","true")):(l.classList.remove("is-active"),l.setAttribute("aria-selected","false"))})}}},v=()=>{if(!a||(a.innerHTML="",d().length<=1))return;const p=e.scrollWidth-e.clientWidth;if(p<=5)return;const f=h(),n=Math.ceil(p/f)+1,g=Math.min(Math.max(3,n),5);for(let l=0;l<g;l++){const c=document.createElement("button");c.type="button",c.className=`carousel-dot ${l===0?"is-active":""}`,c.setAttribute("role","tab"),c.setAttribute("aria-label",`Ir para slide ${l+1}`),c.setAttribute("aria-selected",l===0?"true":"false"),c.addEventListener("click",()=>{const L=p/(g-1)*l;e.scrollTo({left:L,behavior:"smooth"})}),a.appendChild(c)}};s&&s.addEventListener("click",u=>{u.preventDefault();const p=e.scrollLeft,f=e.scrollWidth-e.clientWidth,n=h();p<=10?e.scrollTo({left:f,behavior:"smooth"}):e.scrollTo({left:Math.max(0,p-n),behavior:"smooth"})}),o&&o.addEventListener("click",u=>{u.preventDefault();const p=e.scrollLeft,f=e.scrollWidth-e.clientWidth,n=h();p>=f-10?e.scrollTo({left:0,behavior:"smooth"}):e.scrollTo({left:Math.min(f,p+n),behavior:"smooth"})}),t&&t.length&&i&&i.length&&t.forEach(u=>{u.addEventListener("click",p=>{p.preventDefault();const f=u.getAttribute("data-target-pillar");t.forEach(n=>{n.classList.remove("active"),n.setAttribute("aria-selected","false")}),u.classList.add("active"),u.setAttribute("aria-selected","true"),i.forEach(n=>{const g=n.getAttribute("data-pillar");f==="todos"||g===f?(n.style.display="flex",n.style.opacity="0",n.style.transform="translateY(6px)",setTimeout(()=>{n.style.opacity="1",n.style.transform="translateY(0)"},30)):n.style.display="none"}),e.scrollTo({left:0,behavior:"smooth"}),setTimeout(()=>{v(),m()},120)})});let y;e.addEventListener("scroll",()=>{m(),clearTimeout(y),y=setTimeout(m,100)},{passive:!0}),window.addEventListener("resize",()=>{v(),m()},{passive:!0}),v(),setTimeout(m,100)}class $ extends HTMLElement{connectedCallback(){const s=this.querySelector(".product-carousel-track"),o=this.querySelector(".carousel-pagination-arrow.carousel-arrow-prev, .product-carousel-btn-prev"),a=this.querySelector(".carousel-pagination-arrow.carousel-arrow-next, .product-carousel-btn-next"),t=this.querySelector(".carousel-dots-list"),i=this.querySelectorAll(".pillar-btn"),d=this.querySelectorAll(".product-carousel-card, .service-carousel-card");k(s,o,a,t,i,d)}}customElements.get("product-carousel")||customElements.define("product-carousel",$);function D(e=document){e.querySelectorAll(".services-catalog-section, .product-carousel-section, .product-carousel-wrapper").forEach(o=>{const a=o.querySelector(".product-carousel-track"),t=o.querySelector(".carousel-pagination-arrow.carousel-arrow-prev, .product-carousel-btn-prev"),i=o.querySelector(".carousel-pagination-arrow.carousel-arrow-next, .product-carousel-btn-next"),d=o.querySelector(".carousel-dots-list"),h=o.querySelectorAll(".pillar-btn"),m=o.querySelectorAll(".product-carousel-card, .service-carousel-card");k(a,t,i,d,h,m)})}document.addEventListener("DOMContentLoaded",()=>{const e=document.getElementById("navMenuToggle"),s=document.querySelector(".nav-links");e&&s&&(e.addEventListener("click",o=>{o.stopPropagation();const a=s.classList.toggle("is-open");e.setAttribute("aria-expanded",a?"true":"false")}),document.addEventListener("click",o=>{!e.contains(o.target)&&!s.contains(o.target)&&(s.classList.remove("is-open"),e.setAttribute("aria-expanded","false"))})),O(),D(),F(),G()});function F(){var g;const e=document.getElementById("heroCtaBtn"),s=document.getElementById("heroCtaSlot");if(!e||!s)return;const o=window.matchMedia("(prefers-reduced-motion: reduce)");let a=null,t=null,i=!1;const d=(l,c=0,L=1)=>Math.min(Math.max(l,c),L),h=(l,c,L)=>l+(c-l)*L;function m(){i||(document.body.appendChild(e),i=!0)}function v(){i&&(e.classList.remove("is-docked","is-morphing"),s.classList.remove("is-reserved"),s.style.removeProperty("--hero-cta-slot-width"),s.style.removeProperty("--hero-cta-slot-height"),e.style.removeProperty("--morph-width"),e.style.removeProperty("--morph-height"),e.style.removeProperty("--morph-x"),e.style.removeProperty("--morph-y"),e.style.removeProperty("--morph-text-opacity"),e.style.removeProperty("--morph-icon-opacity"),e.style.removeProperty("--morph-icon-scale"),s.appendChild(e),i=!1)}function y(){i&&v();const l=e.getBoundingClientRect(),c=window.scrollY||window.pageYOffset,L=l.top+c,q=Math.max(0,L-window.innerHeight*.62),r=d(window.innerHeight*.48,300,440),b=window.innerWidth<=768?58:56;s.style.setProperty("--hero-cta-slot-width",`${l.width}px`),s.style.setProperty("--hero-cta-slot-height",`${l.height}px`),s.classList.add("is-reserved"),m(),e.classList.add("is-morphing"),e.style.setProperty("--morph-width",`${b}px`),e.style.setProperty("--morph-height",`${b}px`),e.style.setProperty("--morph-x","0px"),e.style.setProperty("--morph-y","0px");const w=e.getBoundingClientRect();return{sourceLeft:l.left,sourceTop:L-q,sourceWidth:l.width,sourceHeight:l.height,targetLeft:w.left,targetTop:w.top,targetRight:w.right,targetBottom:w.bottom,targetSize:b,startScroll:q,travel:r}}function u(l){const c=l*l*(3-2*l),L=h(a.sourceWidth,a.targetSize,c),q=h(a.sourceHeight,a.targetSize,c),r=h(a.sourceLeft,a.targetLeft,c),b=h(a.sourceTop,a.targetTop,c),w=a.targetRight-L,A=a.targetBottom-q,C=1-d((l-.12)/.52),E=d((l-.38)/.4);m(),e.classList.add("is-morphing"),e.classList.toggle("is-docked",l>=.995),e.style.setProperty("--morph-width",`${L.toFixed(2)}px`),e.style.setProperty("--morph-height",`${q.toFixed(2)}px`),e.style.setProperty("--morph-x",`${(r-w).toFixed(2)}px`),e.style.setProperty("--morph-y",`${(b-A).toFixed(2)}px`),e.style.setProperty("--morph-text-opacity",C.toFixed(3)),e.style.setProperty("--morph-icon-opacity",E.toFixed(3)),e.style.setProperty("--morph-icon-scale",h(.72,1,E).toFixed(3))}function p(){if(t=null,a||(a=y()),o.matches){s.getBoundingClientRect().bottom<=0?u(1):v();return}const l=window.scrollY||window.pageYOffset,c=d((l-a.startScroll)/a.travel);c<=0?v():u(c)}function f(){t===null&&(t=window.requestAnimationFrame(p))}function n(){a=null,f()}window.addEventListener("scroll",f,{passive:!0}),window.addEventListener("resize",n,{passive:!0}),window.addEventListener("orientationchange",n,{passive:!0}),window.addEventListener("pageshow",n),(g=window.visualViewport)==null||g.addEventListener("resize",n,{passive:!0})}function G(){const e=document.getElementById("main-product-img"),s=document.querySelectorAll(".thumb-card"),o=document.querySelectorAll(".model-option"),a=document.getElementById("qty-input"),t=document.getElementById("qty-minus"),i=document.getElementById("qty-plus"),d=document.querySelectorAll(".quick-qty-btn"),h=document.querySelectorAll(".tier-card"),m=document.getElementById("summary-unit-price"),v=document.getElementById("summary-total-price"),y=document.getElementById("summary-items-count"),u=document.getElementById("sticky-total-price"),p=document.getElementById("btn-buy-whatsapp"),f=document.getElementById("btn-sticky-whatsapp");if(!e||!a)return;s.forEach(r=>{r.addEventListener("click",()=>{s.forEach(A=>A.classList.remove("is-active")),r.classList.add("is-active");const b=r.getAttribute("data-img"),w=r.getAttribute("data-alt");e.style.opacity="0.3",setTimeout(()=>{e.src=b,e.alt=w,e.style.opacity="1"},120)})});let n="classica",g="Branca Clássica",l=0;o.forEach(r=>{r.addEventListener("click",()=>{var b;o.forEach(w=>w.classList.remove("is-selected")),r.classList.add("is-selected"),n=r.getAttribute("data-model"),g=((b=r.querySelector(".opt-name"))==null?void 0:b.textContent)||"Branca Clássica",l=parseFloat(r.getAttribute("data-extra")||"0"),n==="classica"?c(0):n==="magica"?c(1):n==="colorida"?c(2):n==="presente"&&c(4),q()})});function c(r){s[r]&&s[r].click()}function L(r){return r>=50?19.9:r>=15?24.9:r>=5?29.9:35}function q(){let r=parseInt(a.value,10);(isNaN(r)||r<1)&&(r=1);const w=L(r)+l,A=w*r,C=w.toLocaleString("pt-BR",{style:"currency",currency:"BRL"}),E=A.toLocaleString("pt-BR",{style:"currency",currency:"BRL"});m&&(m.textContent=`${C} / un`),v&&(v.textContent=E),y&&(y.textContent=`(${r} ${r===1?"unidade selecionada":"unidades selecionadas"})`),u&&(u.textContent=E),h.forEach(x=>{const P=parseInt(x.getAttribute("data-min"),10),T=parseInt(x.getAttribute("data-max"),10);r>=P&&r<=T?x.classList.add("is-current"):x.classList.remove("is-current")}),d.forEach(x=>{parseInt(x.getAttribute("data-qty"),10)===r?x.classList.add("is-active"):x.classList.remove("is-active")});const M=`Olá VM Gráfica! Gostaria de fazer o pedido de:
...
Podem me orientar sobre o envio da arte e prazo de produção?`,S=`https://wa.me/5562993725371?text=${encodeURIComponent(M)}`;p&&(p.href=S),f&&(f.href=S)}t&&t.addEventListener("click",()=>{let r=parseInt(a.value,10)||1;r>1&&(a.value=r-1,q())}),i&&i.addEventListener("click",()=>{let r=parseInt(a.value,10)||1;a.value=r+1,q()}),a&&(a.addEventListener("input",q),a.addEventListener("change",q)),d.forEach(r=>{r.addEventListener("click",()=>{const b=parseInt(r.getAttribute("data-qty"),10);a.value=b,q()})}),q()}
